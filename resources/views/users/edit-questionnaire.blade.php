    ...
    <body>
        @include('incl.header')
                <div class="container mt-5">
                    <h1 class="text-center">Επεξεργασία ερωτηματολογίου</h1>
                </div>
                <div class="container mt-5">
                    <form class="questionnaire-form" method="POST" action="{{route('post.edit')}}">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control" name="title" placeholder="Τίτλος" value="{{$questionnaire['title']}}">
                        </div>
                        <div class="form-group">
                            <h2>Ερωτήσεις</h2>
                        </div>
                        ...
                        @foreach($questionnaire['questions'] as $question)
                            <div class="add-more-group">
                                <label>Ερώτηση {{ $loop->index + 1 }}</label>
